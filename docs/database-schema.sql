...
-- ----------------------------------------------------------------------------
-- Migration 014 — leaving WYN. A profile can outlive its login so that
-- deleting an account erases the person without destroying other people's
-- events, guestlists, messages and recaps.
-- ----------------------------------------------------------------------------
alter table public.profiles
